...
public class GaussDBSchema extends AbstractSchema<GaussDBGlobalState, GaussDBSchema.GaussDBTable> {
    ...
    public enum GaussDBDataType {
        ...
        public static GaussDBDataType getRandom(GaussDBGlobalState globalState) {
                ...
                for (int i = 0; i < getColumns().size(); i++) {
                    ...
                    if (randomRowValues.getString(columnIndex) == null) {
                        ...
                        case INT:
                            ...
                            constant = GaussDBConstant.createIntConstant((long) value);
                            break;
                        case VARCHAR:
                            value = randomRowValues.getString(columnIndex);
                            constant = GaussDBConstant.createStringConstant((String) value);
                            break;
                        case DATE: {
    ...
    public static class GaussDBTable extends AbstractRelationalTable<GaussDBColumn, GaussDBIndex, GaussDBGlobalState> {
    ...
    public static GaussDBSchema fromConnection(SQLConnection con, String databaseName) throws SQLException {
        Exception ex = null;
        for (int i = 0; i < NR_SCHEMA_READ_TRIES; i++) {
            try {
                ...
                try (Statement s = con.createStatement()) {
                    try (ResultSet rs = s.executeQuery(
                        ...
                        while (rs.next()) {
                            ...
                            GaussDBTable.GaussDBEngine engine = GaussDBTable.GaussDBEngine.get(tableEngineStr);
                            ...
                            GaussDBTable t = new GaussDBTable(tableName, databaseColumns, indexes, engine);
                ...
                return new GaussDBSchema(databaseTables);
    ...
    public GaussDBSchema(List<GaussDBTable> databaseTables) {
